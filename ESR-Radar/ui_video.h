...
public:
    ...
    void setupUi(QWidget *video)
    {
        ...
        video->setStyleSheet(QLatin1String("QToolTip\n"
"{\n"
...
"border-radius: 8px;\n"
"}"));
        LB_Video = new QLabel(video);
        LB_Video->setObjectName(QStringLiteral("LB_Video"));
        LB_Video->setGeometry(QRect(0, 0, 640, 480));
    ...
    {
        video->setWindowTitle(QApplication::translate("video", "Video", 0));
        LB_Video->setText(QApplication::translate("video", "<html><head/><body><p align=\"center\"><span style=\" font-size:28pt; font-weight:600; color:#ffffff;\">Video</span></p></body></html>", 0));
    } // retranslateUi
