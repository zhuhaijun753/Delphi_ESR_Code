...
public:
    ...
    void setupUi(QWidget *messagebox)
    {
        ...
        messagebox->resize(230, 80);
        messagebox->setMinimumSize(QSize(230, 80));
        messagebox->setMaximumSize(QSize(230, 80));
        messagebox->setStyleSheet(QLatin1String("QToolTip\n"
"{\n"
...
"}\n"
""));
        PB_OK = new QPushButton(messagebox);
        PB_OK->setObjectName(QStringLiteral("PB_OK"));
        PB_OK->setGeometry(QRect(150, 50, 75, 23));
        LB_Message = new QLabel(messagebox);
        LB_Message->setObjectName(QStringLiteral("LB_Message"));
        LB_Message->setGeometry(QRect(10, 20, 211, 16));
    ...
    {
        messagebox->setWindowTitle(QApplication::translate("messagebox", "MessageBox", 0));
        PB_OK->setText(QApplication::translate("messagebox", "OK", 0));
        LB_Message->setText(QApplication::translate("messagebox", "Message", 0));
    } // retranslateUi
